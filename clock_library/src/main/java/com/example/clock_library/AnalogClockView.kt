package com.example.clock_library
...
import com.example.vkanalogclock.R
...
class AnalogClockView : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //create PointerPaint
        mPointerPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            textSize = mRadius/10
        }
        ...
        for (i in 0..11) {
            ...
            canvas?.drawText((i).toString(),xyData[0]-15f, xyData[1]+15f, mPointerPaint)
        }
